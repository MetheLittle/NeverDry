...
const I18N = {
  ...
  de: {
    ...
    warn_no_guard_flow: "Keine Bemessungs-Durchflußmenge — die voraussichtliche Dauer ist unbekannt",
    designFlow: "Bemessungs-Durchflußmenge (von den Emittern)",
    measuredFlow: "Gemessener Durchfluß (tatsächlich)",
    awaitingValve: "Ventil wird geöffnet…",
    flowLearning: "lernt",
    ofDesign: "der Bemessung",
    ...
    measured_wind_raw: "Windgeschwindigkeit",
    measured_solar_w_m2: "Sonnenstrahlung",
    measured_soil_moisture_raw: "Bodenfeuchte (roh)",
    derived_temp_max_c: "Tageshöchstwert",
    derived_temp_min_c: "Tagestiefstwert",
    ...
    derived_wind_2m_m_s: "Wind auf 2 m Höhe",
